  ...
  return (
    <>
      ...
      <section className="main-card--cointainer">
        ...
        {Cart.map((curElem) => {
          const { ID, Name, CategoryName, Price, Image, Description } = curElem;
          return <>
            <div className="card-container">
              <div className="card" key={ID}>
                ...
                <div className="btn-pric">
                  ...
                  <button className="button-card " onClick={() => DecNum(ID, Name, CategoryName, Price, Description, Image)}>-</button>
